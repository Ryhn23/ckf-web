...
const SETTINGS = [
  ...
  ['about_show_history', 'true'],
  ['about_show_vision', 'true'],
  ['about_show_values', 'true'],
  ['about_show_team', 'true'],
  ['about_show_partnership', 'true'],
  ...
  ['about_mission_desc', 'Menyelenggarakan bantuan tepat sasaran, pembinaan kapasitas, serta menjaga tata kelola lembaga yang akuntabel.'],
  ['about_integrity_title', 'Integritas'],
  ['about_integrity_desc', 'Menerapkan tata kelola organisasi yang transparan, audit berkala, dan kepatuhan terhadap regulasi.'],
  ...
  ['about_val2_desc', 'Merespons kebutuhan riil masyarakat prasejahtera dengan pendekatan kemanusiaan yang berkeadilan.'],
  ['about_val3_title', 'Kolaborasi Strategis'],
  ['about_val3_desc', 'Bermitra dengan pemerintah, sektor swasta, dan komunitas demi optimalisasi dampak program.'],
  ['about_val4_title', 'Keberlanjutan'],
